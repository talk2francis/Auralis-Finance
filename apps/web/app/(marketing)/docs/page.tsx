...
const docs = [
  ["Judge Guide", "/docs/JUDGE_GUIDE.md", "The fastest 5-minute and 15-minute demo paths."],
  ["Tutorial", "/docs/TUTORIAL.md", "Step-by-step USDY closed-loop walkthrough."],
  ["API", "/docs/API.md", "Public endpoints, schemas, examples, and rate limits."],
  ["Security", "/docs/SECURITY.md", "Non-custodial rules, threat model, Slither notes."],
  ["Contracts", "/docs/CONTRACTS.md", "Mantle deployments, ABIs, and verification notes."],
  ["Business Model", "/docs/BUSINESS_MODEL.md", "Revenue lines and GTM plan."],
];
